...
/// Fetches time-based user reminders and notification delivery state from the API.
class UserReminderRepository implements ReminderDataSource {
  UserReminderRepository(this._api);
