...
mixin _$PluginCatalogItem {
 ...
 String get slug; String get name; String get description; String? get version;@JsonKey(name: 'icon_url') String? get iconUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,slug,name,description,version,iconUrl);

@override
String toString() {
  return 'PluginCatalogItem(slug: $slug, name: $name, description: $description, version: $version, iconUrl: $iconUrl)';
}
...
@useResult
$Res call({
 String slug, String name, String description, String? version,@JsonKey(name: 'icon_url') String? iconUrl
});
...
/// Create a copy of PluginCatalogItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? slug = null,Object? name = null,Object? description = null,Object? version = freezed,Object? iconUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String slug,  String name,  String description,  String? version, @JsonKey(name: 'icon_url')  String? iconUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PluginCatalogItem() when $default != null:
return $default(_that.slug,_that.name,_that.description,_that.version,_that.iconUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String slug,  String name,  String description,  String? version, @JsonKey(name: 'icon_url')  String? iconUrl)  $default,) {final _that = this;
switch (_that) {
case _PluginCatalogItem():
return $default(_that.slug,_that.name,_that.description,_that.version,_that.iconUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String slug,  String name,  String description,  String? version, @JsonKey(name: 'icon_url')  String? iconUrl)?  $default,) {final _that = this;
switch (_that) {
case _PluginCatalogItem() when $default != null:
return $default(_that.slug,_that.name,_that.description,_that.version,_that.iconUrl);case _:
  return null;
...
class _PluginCatalogItem implements PluginCatalogItem {
  const _PluginCatalogItem({required this.slug, required this.name, required this.description, this.version, @JsonKey(name: 'icon_url') this.iconUrl});
...
/// Create a copy of PluginCatalogItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? slug = null,Object? name = null,Object? description = null,Object? version = freezed,Object? iconUrl = freezed,}) {
